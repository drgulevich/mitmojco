...
/* private methods */
int mitmojco_nfloats_in_file(char *filename);
void mitmojco_loadamps(char *filename, double complex *p, double complex *A, double complex *B);
...
**************************************************************************************************/
TunnelCurrentType* mitmojco_create(char *filename, double a_supp, double kgap, double dt, int Ntotal, double *phi, int Nskip, int *skipinds) {
